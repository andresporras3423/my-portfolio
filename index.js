...
var app = new Vue({
    ...
    data:{
      ...
      {name: 'Booking Lessons', description: 'This project is an API about students booking lessons with tutors in the same city', github:'https://github.com/andresporras3423/booking-lessons', live:'https://still-island-68637.herokuapp.com/countries/show', url:'./src/assets/booking-lessons.png', tools:['Ruby', 'Ruby on Rails', 'SQL']}]
    }
  });