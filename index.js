...
var app = new Vue({
    ...
    data:{
      ...
      {name: 'Platform game', description: 'A  platform game built with Phaser3 and JavaScript. Inspired by the running dinosaur game', github:'https://github.com/andresporras3423/booking-lessons', live:'https://github.com/andresporras3423/platform-game', url:'./src/assets/platform-game.png', tools:['JavaScript', 'HTML/CSS', 'Webpack']}]
    }
  });